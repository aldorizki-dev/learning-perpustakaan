<nav x-data="{ open: false }" class="bg-white dark:bg-zinc-800 border-b border-zinc-100 dark:border-zinc-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.daftar-buku')" :active="request()->routeIs('admin.daftar-buku')">
                        {{ __('Daftar Buku') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.daftar-rak')" :active="request()->routeIs('admin.daftar-rak')">
                        {{ __('Daftar Rak') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.daftar-buku')" :active="request()->routeIs('admin.daftar-buku')">
                {{ __('Daftar Buku') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.daftar-rak')" :active="request()->routeIs('admin.daftar-rak')">
                {{ __('Daftar Rak') }}
            </x-responsive-nav-link>
        </div>
